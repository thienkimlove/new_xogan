...
<head>
    ...
    <meta property="og:site_name" content="Chuyên trang về bệnh xơ gan, viêm gan, viêm gan b, viêm gan virus, giải độc gan">
    <meta property="fb:app_id" content="1217332968412379"/>
    <title>{{!empty($meta_title)? $meta_title : 'Chuyên trang về bệnh xơ gan, viêm gan, viêm gan b, viêm gan virus, giải độc gan'}}</title>
    ...
    <meta name="google-site-verification" content="EURMfIPlSXP0UEDieIraF9t5nFBu1a9rC5NaVHjcliY" />
    <style>
        .tn-thumb {
    ...
    <meta name="description" content="{{!empty($meta_desc)? $meta_desc : 'Chuyên trang về bệnh xơ gan, viêm gan, viêm gan b, viêm gan virus, giải độc gan'}}"/>
    <meta name="keyword" content="{{!empty($meta_keywords)? $meta_keywords : 'Chuyên trang về bệnh xơ gan, viêm gan, viêm gan b, viêm gan virus, giải độc gan'}}"/>
        ...
        <div class="content">
            ...
            <form id="register_form" action="{{ url('saveRegister') }}" method="POST">
                ...
                <div class="note">
                    ...
                    <a href="{{ url('dieu-khoan-su-dung') }}" title="Điều khoản quy định" target="_blank">Điều khoản quy định</a>
                    của sinhlucnam.vn
                </div>
                <a href="javascript:void(0)" id="click_register" class="btn-create" title="Tạo tài khoản">Tạo tài khoản</a>
                <div id="errors" style="display: none" class="errors">Vui lòng nhập đầy đủ các thông tin trên</div>
            </form>
        </div>
    </div>
</div>
    ...
    <div class="popup-content pa">
        ...
        <div class="content">
            ...
            <form action="">
                ...
                <a href="{{ url('/') }}" class="btn-login" title="Tạo tài khoản">Đăng nhập</a>
                <div class="rows">
